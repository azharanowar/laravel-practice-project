                    ...
                    <div class="row gy-4 posts-list">
                        ...
                        <div class="col-lg-6">
                            <article class="d-flex flex-column">
                                ...
                                <div class="post-img">
                                    <img src="{{ asset('frontEndAssets') }}/assets/img/blog/blog-2.jpg" alt="" class="img-fluid">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <article class="d-flex flex-column">
                                ...
                                <div class="post-img">
                                    <img src="{{ asset('frontEndAssets') }}/assets/img/blog/blog-3.jpg" alt="" class="img-fluid">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <article class="d-flex flex-column">
                                ...
                                <div class="post-img">
                                    <img src="{{ asset('frontEndAssets') }}/assets/img/blog/blog-4.jpg" alt="" class="img-fluid">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <article class="d-flex flex-column">
                                ...
                                <div class="post-img">
                                    <img src="{{ asset('frontEndAssets') }}/assets/img/blog/blog-5.jpg" alt="" class="img-fluid">
                                </div>
                        ...
                        <div class="col-lg-6">
                            <article class="d-flex flex-column">
                                ...
                                <div class="post-img">
                                    <img src="{{ asset('frontEndAssets') }}/assets/img/blog/blog-6.jpg" alt="" class="img-fluid">
                                </div>
